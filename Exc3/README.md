...
| Категория                | Используемые технологии  | Предлагаемые технологии                      |
|--------------------------|--------------------------|----------------------------------------------|
| Хранилище данных         | MS SQL Server 2008 (DWH) | PostgreSQL + ClickHouse                      |
| Шина данных и интеграции | Apache Camel             | Kafka                                        |
| Финтех-сервисы           | Java, Golang             | Остаются, но с интеграцией через DataLake    |
| ИИ-сервисы               | Python                   | Остаются, но с интеграцией через DataLake    |
| Витрина данных           | DWH + Power BI           | DWH + DataLake (либо DataLakeHouse) + DataHub + портал самообслуживания |
| Архитектурный подход     | Централизованное DWH     | DataMesh (разделение на домены)              |
