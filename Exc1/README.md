...
3. Интеграционная шина на Apache Camel. Имеет ограничение пропускной способности, что будет ограничивать потенциал роста при развитии сервисов компании. Отсутствие потоковой обработки.
...
2. Внедрение брокера сообщений с асинхронной обработкой данных для потоковых данных (Kafka). Переходим на событийную архитектуру для снижения связности, переводим логику по доставке сообщений из Apache Camel.
...
1. Отсутствует поддержка обработки неструктурированных и полуструктурированных, потоковых данных. В качестве решения рассматриваем возможность использования существующего DWH (с миграцией на более современную версию) при этом дополняем решение DataLake для хранения и обработки полуструктурированных и неструктурированных данных. Как альтернативу рассмотреть внедрения DataLakeHouse c миграцией текущего DWH в контур решения, но стоит учитывать трудность внедрения и поддержку.